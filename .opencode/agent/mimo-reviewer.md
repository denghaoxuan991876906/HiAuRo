---
description: Spec review subagent powered by MIMO 2.5-pro. Use ONLY when asked to review a design spec or architecture document for completeness, consistency, and ambiguity. Do NOT use for code review or implementation tasks.
mode: subagent
