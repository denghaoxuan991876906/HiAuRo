    ...
    void DrawShape()
    {
        ...
        switch (_shapeType)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                renderer.ShowFan(_shapePos, _fanRadius, VfxRenderer.AngleFromDeg(_fanArcDeg),
            ...
            case 5:
                renderer.ShowRingFan(_shapePos, _rfInnerR, _rfOuterR,
                    VfxRenderer.AngleFromDeg(_rfArcDeg), _rfFacingDeg * MathF.PI / 180f,
